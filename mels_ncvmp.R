...
bootstrap_mels_ncvmp <- function(model_object, B = 1000, 
  ...
  if (parallel) {
    ...
    functions_to_export <- c(
      "mels_ncvmp", "mels_ncvmp_fitter", "mels_ncvmp_ncr_fitter", "psi_alpha", 
      "psi_tau", "psi_omega", "psi_z", "beta_update_ncr", "nui_grad_hes_ncr", 
      "nu_update_ncr", "alpha_update_ncr", "tau_update_ncr", "omega_grad_hess_ncr", 
      "omega_update_ncr", "sigma_inv_update_ncr", "a_inv_update_ncr", "elbo_cal_ncr"
    )
